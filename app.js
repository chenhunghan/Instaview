...
(function() {
  var AppCtrl, FlowChartController, debug, flowchart, hasClassSVG, removeClassSVG;

  flowchart = {};

  (function() {
    var computeConnectionTangentOffset, createConnectorsViewModel, createNodesViewModel;
  ...
  angular.module("app", ["flowChart"]).factory("prompt", function() {
    return prompt;
  }).controller("AppCtrl", [
    "$scope", "prompt", AppCtrl = function($scope, prompt) {
